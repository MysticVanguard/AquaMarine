...
CREATE TABLE IF NOT EXISTS user_item_inventory (
    user_id BIGINT,
    inverted_fish_bag INT NOT NULL DEFAULT 0,
    high_level_fish_bag INT NOT NULL DEFAULT 0,
    fish_flakes INT NOT NULL DEFAULT 0,
    fish_revival INT NOT NULL DEFAULT 0,
    fish_pellets INT NOT NULL DEFAULT 0,
    fish_wafers INT NOT NULL DEFAULT 0,
    experience_potion INT NOT NULL DEFAULT 0,
    mutation_potion INT NOT NULL DEFAULT 0,
    feeding_potion INT NOT NULL DEFAULT 0,
