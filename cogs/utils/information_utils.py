...
async def tanks_background_image_creator(ctx, tank_rows):
    ...
    position_glass = {
        "Fish Bowl": [(390, 160), (1470, 160), (2510, 160),
                      (390, 640), (1470, 640), (2510, 640),
                      (950, 1170), (1970, 1170), (950, 1540),
                      (1970, 1540),
                      ],
        "Small Tank": [(350, 40), (1400, 40), (2450, 40),
                       (350, 520), (1400, 520), (2450, 520),
                       (890, 1050), (1900, 1050), (809, 1440),
                       (1900, 1440),
                       ],
        "Medium Tank": [(240, 40), (1290, 40), (2340, 40),
                        (240, 520), (1290, 520), (2340, 520),
                        (770, 1050), (1780, 1050), (770, 1440),
                        (1780, 1440),
                        ],
    }
    ...
    position_theme = {
        ...
        "Small Tank": [(360, 70), (1410, 70), (2460, 70),
                       (360, 550), (1410, 550), (2460, 550),
                       (900, 1080), (1910, 1080), (900, 1470),
                       (1910, 1470),
                       ],
        "Medium Tank": [(250, 70), (1300, 70), (2350, 70),
                        (250, 550), (1300, 550), (2350, 550),
                        (780, 1080), (1790, 1080), (780, 1470),
                        (1790, 1470),
                        ],
    }
...
help_descriptions = {
    "prefix": ("prefix *new prefix*", "This command will change the prefix of the bot in your server."),
    "info": (
        "info",
    ...
    "vote": ("vote", "This will give a link to top.gg, where you can vote to unlock a 1.5x bonus to gained sand dollars and access to the daily command for that day."),
    "stats": ("stats", "This command will show various info about the bot, including the creator, votes, and guild (server) count."),
    "firsttank": ("firsttank", "This command needs to be used before you can have a tank, and it will give you your first starter tank with 1 point of space."),
    "preview": ("preview *theme*", "This command will preview the given theme, on the tank type (chosen after via select box)."),
    "fish": (
        "fish",
    ...
    "rename": ("rename \"*old fish/tank's name*\" \"*new fish/tank's name*\"", "This command will let you rename a fish or tank to a new name, prioritizing the tank name if there is both a fish and tank with the name."),
    "craft": (
        "craft __item name__",
    ...
    "stab": ("stab *mention user*", "This command will send a cute gif and stab another user."),
    "bug": ("bug *command name* *report of problem*", "This command can be used to report any problems you see in the bot that you don't think are intentional."),
    "support": ("support", "This command will give a link to the support server for the bot, where there is a growing community and cute aqua emotes."),
    "shop": ("shop", "This command sends a paginated embed of the shop, with various items for sale."),
    "buy": ("buy \"*item*\" __amount__", "This command is used to buy an amount of an item that is listed in the shop."),
    "use": (
        "use *item*",
    ...
    "inventory": ("inventory", "This command will show you how many of each different item you have."),
    "balance": ("balance __user mention__", "This command will show your balance, or a mentioned user's balance if one's given."),
    "sell": ("sell *fish name*", "This command will sell a fish, increasing with the level of fish sold."),
    "daily": ("daily", "This command will let you spin a wheel of prizes of voted, where you can win up to 4,800 sand dollars."),
    "gamble": ("gamble *amount divisible by 100*", "This command let's you gamble and win or lose your sand dollars."),
    "upgrades": ("upgrades", "This will show your progression in upgrades, each giving various buffs and bonuses. The previous upgrade must be fully upgrade before the next tier is unlocked."),
    "upgrade": ("upgrade *upgrade name*", "This will upgrade the given upgrade by one if you have enough sand dollars to do so."),
    "tanks": ("tanks", "This will show various info on all the tanks you have, and the fish inside them."),
    "profile": (
        "profile",
    ...
    "fishbucket": ("fishbucket __user mention__", "This command will give you a paginated embed of all the fish you have kept, giving info about their name, size, if they are alive, and if they have a skin."),
    "achievements": (
        "achievements",
    ...
    "guide": ("guide", "This command is used to learn how to use the bot, and explains the commands and interworkings of the bot much more in depth."),
    "totalfish": ("totalfish", "This command is used to see a ranking of the most kept fish in the bot to the least kept fish."),
    "help": ("help __command__", "This command gives general info on each command, or specific info on a singular command if one is specified.")
